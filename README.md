# AudioStudio — React Native Audio Recording & Processing App (for audiostudio branch)

AudioStudio is a React Native mobile application that enables audio recording, storage, and native audio processing on Android using modern native architecture.

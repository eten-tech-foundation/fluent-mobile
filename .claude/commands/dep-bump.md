...
- Agent-authored lockfile / doctor fixes still need a **ticketed PR** — never push to `main` ([delivery.mdc](../../.cursor/rules/delivery.mdc)).
...
Hand off to `/create-pr` (or `/start-issue` if there is not yet a branch) when the user wants a PR.

## Related

- [docs/ci.md](../../docs/ci.md)
- [docs/guides/dependabot-process.md](../../docs/guides/dependabot-process.md)
- [`.cursor/rules/dependabot-workflow.mdc`](../../.cursor/rules/dependabot-workflow.mdc)

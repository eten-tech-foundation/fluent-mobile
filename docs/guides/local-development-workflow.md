...
- Node **≥ 24.14.0**, **npm** (`package-lock.json`). Habitual `yarn` is forwarded to npm; `preinstall` still blocks pnpm. See [README troubleshooting](../../README.md#troubleshooting).
